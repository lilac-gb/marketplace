...
<tr>
    <td style="padding:30px;"><h3>Для продолжения регистрации перейдите по ссылке в данном письме, подтверждающей ваш
            e-mail</h3>
...
<tr>
    <td style="background-color:  #4e2984;padding: 10px 15px 10px 15px;color: #fff;font-size: 77%;">
        <p style="text-align: center;">Данное письмо сгенерировано автоматически. Вы получили его на адрес
            <a style="color: #FFFFFF" href="<?= $model->email ?>"><?= $model->email ?></a> так как кто-то инициировал
            процесс регистрации. В случае, если Вы этого не делали, просто проигнорируйте это письмо.
        </p>
    </td>
</tr>